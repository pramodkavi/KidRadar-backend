...
//     const id = req.params.id;
//     const updateData = req.body;
//     const updatedPreschool = await PreSchoolModel.findByIdAndUpdate(
//       id,
//       updateData,
//       { new: true }
//     );
...
// Above is my server.js file. I need to change the code structure qith better routing with routes and controller